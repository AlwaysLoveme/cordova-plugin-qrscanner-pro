<a name="3.0.2"></a>
## [3.0.2](https://github.com/AlwaysLoveme/cordova-plugin-qrscanner-pro/compare/2.6.0...3.0.2) (2021-06-01)


### Bug Fixes

* **syntax:** Swift 5 ([692c126](https://github.com/AlwaysLoveme/cordova-plugin-qrscanner-pro/commit/692c126))
* **tag:** removes invalid tag UseSwiftLanguageVersion ([3c368fe](https://github.com/AlwaysLoveme/cordova-plugin-qrscanner-pro/commit/3c368fe))



<a name="3.0.2"></a>
## [3.0.2](https://github.com/bitpay/cordova-plugin-qrscanner/compare/2.6.0...3.0.1) (2021-06-01)
### Features

* **iOS/Android:** 增加对条形码扫描
